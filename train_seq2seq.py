...
class TransformerTrainer(training.Trainer):
    ...
    def create_parser(model_name):
        ...
        group = parser['model']
        group.add_argument('--share-embedding', '-S', type=strtobool, default=None, nargs='?', const=True, help='Using single shared embedding for source and target (default: {})'.format(default.model.share_embedding))
