...
class Bert(chainer.Chain):
    def __init__(self, vocab, **params):
        ...
        self.universal = params.get('universal',False)
        ...
        with self.init_scope():
            if self.relative_attention:
                transformer.Transformer._init_relative_attention(self, **params)
            ...
            if self.universal:
                self.L_transform = universal_transformer.MultiStepTransform(**params, combine=False)
            else:
                self.L_transform = transformer.MultiStepTransform(**params, combine=False)
